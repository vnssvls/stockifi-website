...
benefits:
  - heading: "Recipe costs aligned everywhere"
    body: "A recipe costs the same across every site, and updates everywhere when a supplier price moves."
...
showcaseSubs:
  - heading: "Built for hospitality"
    body: "Recipes, sub-recipes, and central-kitchen costs work the way a group actually runs."
  - heading: "Intelligent data extraction"
    body: "Every site's invoices are read and costed automatically, so prices stay aligned across the group."
