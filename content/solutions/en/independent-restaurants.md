...
problemHeading: "Every leak is small enough to miss"
problemBody: "In a single kitchen the losses are small day to day."
problem:
...
benefits:
  - heading: "Live recipe costs"
    body: "Every recipe re-costs itself as supplier prices move."
  - heading: "Automated invoices"
    body: "Trained on thousands of F&B invoices. Flags pricing mismatches and over-charges."
  - heading: "Variance you can act on"
    body: "Catch where food cost drifts from plan and act on it."
...
showcaseSubs:
  - heading: "Built for hospitality"
    body: "Recipes, sub-recipes, prep, and pour are costed the way a kitchen actually runs."
  - heading: "Intelligent data extraction"
    body: "Continuously learns and improves with every invoice scanned."
...
# testimonials: invented placeholders removed. Add real customer quotes before launch (slider hides when empty).
testimonials: []
