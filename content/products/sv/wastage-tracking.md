---
metaTitle: "Svinnregistrering för restauranger | Stockifi"
...
benefits:
  - heading: "Alla typer av förluster"
    body: "Spill, köksmisstag och överproduktion kostnadsberäknas var för sig."
  - heading: "Taggat med orsak"
    body: "Varje förlust kopplas till en ingrediens och en orsak."
  - heading: "Förklarar gapet"
    body: "Registrerat svinn förklarar avvikelser du inte kunde se tidigare."
  - heading: "De dyraste posterna"
    body: "Se vilka råvaror och orsaker som kostar mest."
faqHeading: "Frågor om svinnregistrering"
faqs:
  - question: "Vilka typer av svinn kan jag registrera?"
    answer: "Spill, tillagningsmisstag och överproduktion. Varje post taggas med ingrediens och orsak, så att kostnaden hamnar på rätt ställe."
  - question: "Vad gäller för putsrester och skäravfall, som avskär från en hel fisk?"
    answer: "Det hanteras via receptets utbyte snarare än svinnregistrering. Du anger hur mycket av en ingrediens ett recept faktiskt använder, och Stockifi räknar in putsförlusten i varje portion. Svinnregistrering är till för förluster utanför receptet, som spill eller en tappad bricka."
