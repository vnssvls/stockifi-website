...
benefits:
  - heading: "Real from wrong"
    body: "A genuine price rise passes, and only a charge that breaks the pattern gets flagged."
  - heading: "More than overcharges"
    body: "Double-bills and duplicate lines get caught as well as price spikes."
  - heading: "Query with proof"
    body: "Each flag shows the charge and what it was checked against."
  - heading: "Money back"
    body: "Catch a billing error early and you can still claim it back."
